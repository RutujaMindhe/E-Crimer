...
session_start();
    ...
    $query="select victim_id,victim_clg_id,victim_name,victim_mobileNo,victim_clg_name,Status from anti_ragging_complaint where Status='pending' order by victim_id desc";
  ...
  <div class="container">
    ...
    <!--<div id="navbar" class="collapse navbar-collapse">
      ...
      <ul class="nav navbar-nav navbar-right">
        ...
        <li class="active"><a href="pending_complaints.php">Pending Complaints</a></li>
