    ...
    if(isset($_POST['close'])){
     ...
     if(isset($_POST['fake'])){
      if($_SERVER["REQUEST_METHOD"]=="POST")
      {
          ...
          $q2=mysqli_query($conn,"update complaint set fakecomplaint=1 where c_id='$cid'");
          
          //$q5=mysqli_query($conn,"CREATE VIEW  V AS(select complaint.c_id, complaint.fakecomplaint,user.Banned FROM complaint,user WHERE  complaint.a_no=user.a_no);");
          $q6=mysqli_query($conn,"UPDATE V SET Banned=1 WHERE fakecomplaint=1");
  ...
  <div class="container">
    ...
    <div id="navbar" class="collapse navbar-collapse">
      ...
      <ul class="nav navbar-nav navbar-right">
        ...
        <li><a href="complaint_details_pdf.php">Generate PDF
    </a></li>
...
?>
  ...
  <div style="width: 100%; height: 250px;"> 
    ...
    <div style="width: 50%;float: left;height: 250px; background-color: #dcdcdc"> 
     ...
     <div>
      <input  class="btn btn-danger" id='btn' type="submit" value="Close Case" name="close" <?php echo isset($_POST["close"]) ? "disabled" : "";
      echo isset($_POST["status"]) ? "disabled" : "";
      echo isset($_POST["fake"]) ? "disabled" : "";?> style="margin-left: 20px; margin-top: 10px; margin-bottom:20px;">
      <input  class="btn btn-danger" type="submit" value="Fake Complaint" name="fake"<?php  echo isset($_POST["fake"]) ? "disabled" : "";?> style="margin-left: 20px; margin-top: 10px; margin-bottom:20px;">
       </div> 
    </form>
  </div>
