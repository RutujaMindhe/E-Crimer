...
if(isset($_POST['s']))
{
    ...
    if($_SERVER["REQUEST_METHOD"]=="POST")
    {
        $c_id=$_POST['c_id'];
        $c_pass=$_POST['c_pass'];
        $result=mysqli_query($conn,"SELECT c_id,c_pass FROM committe where c_id='$c_id' and c_pass='$c_pass' ");
        $_SESSION['pol']=$c_id;       
...
<body style="color: black;background-image: url(3.jpg);background-size: 100%;background-repeat: no-repeat;">
 ...
 <div  align="center" >
  ...
  <div class="form-group" style="width: 30%">
    <label for="exampleInputEmail1"  ><h1 style="color:white">Committee Id</h1></label>
    <input type="text" name="c_id" class="form-control" id="exampleInputEmail1"  size="5" placeholder="Enter user id" required onfocusout="f1()">
     </div>
  <div class="form-group" style="width:30%">
    <label for="exampleInputPassword1"><h1 style="color:white">Password</h1></label>
    <input type="password" name="c_pass" class="form-control" id="exampleInputPassword1" placeholder="Password" required onfocusout="f1()">
  </div>
