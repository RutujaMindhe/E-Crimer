...
document.getElementsByName("d_o_c")[0].setAttribute('max', today);
    }
...
<div class="video" style="margin-top: 5%"> 
	<div class="center-container">
        ...
        <br>
        <p style="color:white; font-size:15px;">If you have any evidence mail us with complaint id on</p>
        <p style="color:white;; font-size:15px;" ><a href="mailto:e_crimer.evidence@yopmail.com">e_crimer.evidence@yopmail.com</a> </p>
			</div>	
		</div>
	</div>	
</div>	
